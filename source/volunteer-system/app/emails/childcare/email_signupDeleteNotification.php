...
function sendSignupDeleteNotificationEmail($acct, $vDate, $numDaysWarning) {
	...
	$vDateURL = "https://".$_SERVER["SERVER_NAME"]."/volunteer-system$stage?page=adminManageVolunteerDate&id=".$vDate['id'];
	...
	$subject = "Kids On The Move - Childcare Cancellation for ".formatDateAsNumeric_monthDayYear($vDate['date'])." in ".$vDate['location'];
	
	$email_body = "----------------(automatically generated message)----------------\n";
	$email_body .= "\n";
	$email_body .= "A volunteer has cancelled his/her sign-up for a Childcare event.\n";
	$email_body .= "\n";
	$email_body .= $acct['firstname']." ".$acct['lastname']." (id: ".$acct['uname'].") has cancelled his/her appointment to volunteer in ".$vDate['location']." on ".formatDateAsText_weekdayMonthDay($vDate['date']).".\n";
	$email_body .= "\n";
