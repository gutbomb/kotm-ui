...
function sendSignupDeleteNotificationEmail($acct, $vDate, $numDaysWarning) {
	...
	$subject = "Kids On The Move - Respite Cancellation for ".formatDateAsNumeric_monthDayYear($vDate['date'])." in ".$vDate['location'];
	
	$email_body = "----------------(automatically generated message)----------------\n";
	$email_body .= "\n";
	$email_body .= "A volunteer has cancelled his/her sign-up for a Respite event.\n";
	$email_body .= "\n";
