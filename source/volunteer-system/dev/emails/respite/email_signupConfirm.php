...
function sendSignupConfirmEmail($acct, $vDate, $link) {
	...
	$email_body .= "\n";
	$email_body .= "Thank you again for volunteering for the Respite program! Please confirm you're still coming by clicking (or copy/paste into your browser) the following link:\n";
	$email_body .= "\n";
